...
columns_list = ['pricing_key', 'combi_boiler', 'manufacturer', 'postal_sector', 'radiators', 'boiler_age', 'tenure_for_discount', 'bundle']
...
avg_ly_price = filtered_premium_file['ly_customer_price'].mean()
...
trace2 = go.Histogram(x=filtered_premium_file['ly_undiscounted_price'], name='LY Price', opacity=0.20,marker_color='red')
